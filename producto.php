...
<?php if($_SESSION['user_name'] == 'baraka') { ?>
					...
					<a href="#myModal2" data-toggle="modal" data-codigo='<?php echo $row['codigo_producto'];?>' data-nombre='<?php echo $row['nombre_producto'];?>' data-categoria='<?php echo $row['id_categoria']?>' data-precio='<?php echo $row['precio_producto']?>'
					 data-dolar='<?php echo $row['precio_dolar']?>' data-stock='<?php echo $row['stock'];?>' data-id='<?php echo $row['id_producto'];?>' class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i> Editar </a>	
					<?php }         ?>
              </div>
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-12">
                      <span class="item-price">$ <?php echo number_format($row['precio_dolar'],2);?></span>
                    </div>
					<div class="col-sm-12">
...
<?php if($row['stock'] > 0) { ?>
            ...
            <div class="col-sm-8 col-sm-offset-2 text-left" id="example">
                  <div class="row">
                    <?php
						if (isset($message)){
							?>
	...
	<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="hidden" class="form-control" id="q" onkeyup='load_historial(1);'>
							</div>
							<!-- <div class="col-md-3">
								<button type="button" class="btn btn-success" onclick='load_historial(1);'>
				...
				<div class='outer_div_historial'></div><!-- Carga los datos ajax -->
