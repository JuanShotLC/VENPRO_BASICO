							...
							<div class="col-sm-4 col-sm-offset-2 text-center">
								...
								<?php if ($_SESSION['user_name'] == 'baraka') { ?>
									...
									<a href="#myModal2" data-toggle="modal"
										...
										data-dolar='<?php echo $row['precio_dolar'] ?>'
										data-stock='<?php echo $row['stock']; ?>' data-id='<?php echo $row['id_producto']; ?>'
										class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i>
										Editar </a>
								<?php } ?>
							</div>
								...
								<div class="row margin-btm-20">
									...
									<div class="col-sm-12">
										<span class="item-price">$
											<?php echo number_format($row['precio_dolar'], 2); ?></span>
									</div>
									<div class="col-sm-12">
										<span class="current-stock"> Precio venta </span>
									</div>
									<div class="col-sm-12">
										<span class="item-price">Bs
											<?php echo number_format($row['precio_producto'], 2, ',', '.'); ?></span>
									</div>
									<?php if ($_SESSION['user_name'] == 'baraka') { ?>
										...
										<div class="col-sm-6 col-xs-6 col-md-4 ">
											<a href="" data-toggle="modal" data-target="#add-stock"><img width="100px"
													src="img/stock-in.png"></a>
										</div>
										<?php if ($row['stock'] > 0) { ?>
											<div class="col-sm-6 col-xs-6 col-md-4">
												<a href="" data-toggle="modal" data-target="#remove-stock"><img width="100px"
														src="img/stock-out.png"></a>
											</div>
