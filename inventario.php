...
<?php if($_SESSION['user_name'] == 'baraka') { ?>
		    ...
		    <div class="btn-group pull-right">
		    	    <a class="btn btn-default" href="reportes/reporte_existencia_minima.php" target="_blank"> PRODUCTOS EXISTENCIA MÍNIMA </a>
		    	    <a class="btn btn-default" href="reportes/reporte_inventario.php" target="_blank"> LISTA DE PRODUCTOS</a>
