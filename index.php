			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<?php if ($_SESSION['user_name'] == 'baraka') { ?>
						...
						<li class="<?php echo $active_reportes; ?>"><a href="reportes.php"><i
									class='glyphicon glyphicon-lock'></i> Reportes</a></li>

						<li class="<?php echo $active_cotizacion; ?>"><a href="cotizacion.php"><i
									class='glyphicon glyphicon-lock'></i> Cotizacion </a></li>
			...
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120">
						<a href='https://www.instagram.com/sistemasvenpro/'>SISTEMAS VENPRO - Sistema Administrativo</a>
