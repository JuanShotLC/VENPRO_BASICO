angular.module('scotchApp').controller('factura_ventaController', function($scope, $interval, loaddatosSRI) {
    ...
    jQuery(function($) {
        ...
        $("#efectivo").on("keypress", function(e) {
            if (e.keyCode == 13) { //tecla del alt para el entrer poner 13
                if ($('#total_pagar_dolar').val() == '0.000') {
                    $.gritter.add({
                    ...
                    if ($('#efectivo').val() <= $('#total_pagar_dolar').val()) {
                        $.gritter.add({
                        ...
                        var cambio = parseFloat($('#efectivo').val() - $('#total_pagar_dolar').val()).toFixed(2);
                        $('#cambio').val(cambio);
                    }
                }
            }
        ...
        // validar cambio_bs
        $("#efectivo_bs").on("keypress", function(e) {
            if (e.keyCode == 13) { //tecla del alt para el entrer poner 13
                if ($('#total_pagar').val() == '0.000') {
                    $.gritter.add({
                        title: 'Error... Ingrese datos a la Factura',
                        class_name: 'gritter-error gritter-center',
                        time: 1000,
                    ...
                    if ($('#efectivo_bs').val() <= $('#total_pagar').val()) {
                        $.gritter.add({
                            title: 'Error... El Efectivo es menor al monto a pagar',
                            class_name: 'gritter-error gritter-center',
                            time: 1000,
                        ...
                        var cambio_bs = parseFloat($('#efectivo_bs').val() - $('#total_pagar').val()).toFixed(2);
