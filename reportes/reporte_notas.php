<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {                         
            ...
            $this->Cell(190, 12, utf8_decode("Reporte de Notas"),0,1, 'C',0);                                                                                                                            
            $this->SetFont('Amble-Regular','',10);        
            //$this->Ln(3);
    ...
    $pdf->SetX(20); 
    $pdf->Cell(22, 6, utf8_decode('Nro Nota'),1,0, 'C',0);                                     
    ...
    $pdf->Cell(40, 6, utf8_decode('Total'),1,1, 'C',0);      
        ...
        $resultado1 = mysqli_query($con,"SELECT F.serie, F.fecha_actual, F.total_venta, F.id,F.estado,F.iva_venta,F.subtotal FROM nota_venta F  WHERE F.estado='1' and F.fecha_actual between '$inicio' and '$fin' order by F.id asc");   
