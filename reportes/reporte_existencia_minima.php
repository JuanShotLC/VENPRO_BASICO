<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {                         
            ...
            $this->Cell(190, 12, utf8_decode("EXISTENCIA MÍNIMA"),0,1, 'C',0);                                                                                                                            
            $this->SetFont('Amble-Regular','',10);        
            //$this->Ln(3);
    ...
    $pdf->Cell(45, 6, utf8_decode('Precio Bs.'),1,0, 'C',0);
    ...
    $pdf->Cell(20, 6, utf8_decode('Stock'),1,1, 'C',0);      
      ...
      $consulta= mysqli_query($con,'SELECT * FROM products  where stock <= 3');
