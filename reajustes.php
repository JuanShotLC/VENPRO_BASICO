...

				{
					...
					echo'<tr>
						...
						<td hidden><input name="idpro[]" value="'.$registroProductos['id_producto'].'" readonly/></td>
						 ...
						 <td><input name="pre_d['.$registroProductos['id_producto'].']" value="'.$registroProductos['stock'].'"readonly /></td>

						

						 <td><input name="dolar_b['.$registroProductos['id_producto'].']" value="'.$registroProductos['stock'].'" /></td>
