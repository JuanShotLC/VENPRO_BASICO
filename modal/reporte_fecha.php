...
<?php
  ...
  ?>
  <!-- Modal -->
  <div class="modal fade" id="reporteVenta" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="GET" action="reportes/reporte_ventas.php" id="guardar_cliente" name="guardar_cliente">
